...
CREATE TABLE `tables` (
  ...
  KEY `Restaurants_idx` (`restaurantId`),
  CONSTRAINT `Restaurants` FOREIGN KEY (`restaurantId`) REFERENCES `restaurants` (`restaurantId`)
...
INSERT INTO `tables` VALUES (1,1,4),(2,1,4),(3,1,4),(4,1,6),(5,1,8),(6,1,6),(7,1,8),(8,1,2),(9,1,2);
