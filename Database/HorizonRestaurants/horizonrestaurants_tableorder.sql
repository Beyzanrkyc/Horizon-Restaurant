...
CREATE TABLE `tableorder` (
  ...
  PRIMARY KEY (`tableNumber`,`orderId`),
  KEY `fk_TableOrder_Tables1_idx` (`tableNumber`),
  KEY `fk_TableOrder_Orders1_idx` (`orderId`),
  CONSTRAINT `fk_TableOrder_Orders1` FOREIGN KEY (`orderId`) REFERENCES `orders` (`orderId`),
  CONSTRAINT `fk_TableOrder_Tables1` FOREIGN KEY (`tableNumber`) REFERENCES `tables` (`tableNumber`)
