...
CREATE TABLE `inventories` (
  ...
  KEY `fk_Inventories_Resturants1_idx` (`restaurantId`),
  CONSTRAINT `fk_Inventories_Resturants1` FOREIGN KEY (`restaurantId`) REFERENCES `restaurants` (`restaurantId`)
...
INSERT INTO `inventories` VALUES (1,1,'Main Inventory');
