...
CREATE TABLE `menus` (
  ...
  PRIMARY KEY (`menuId`),
  KEY `fk_Menus_Resturants1_idx` (`restaurantId`),
  CONSTRAINT `fk_Menus_Resturants1` FOREIGN KEY (`restaurantId`) REFERENCES `restaurants` (`restaurantId`)
...
INSERT INTO `menus` VALUES (2,1,'Main Courses'),(3,1,'Pizzas'),(4,1,'Desserts');
