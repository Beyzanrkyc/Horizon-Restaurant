...
CREATE TABLE `offers` (
  ...
  `MenuDishes_dishId` int NOT NULL,
  PRIMARY KEY (`offerId`),
  KEY `fk_Offers_MenuDishes1_idx` (`MenuDishes_dishId`),
  CONSTRAINT `fk_Offers_MenuDishes1` FOREIGN KEY (`MenuDishes_dishId`) REFERENCES `menudishes` (`dishId`)
