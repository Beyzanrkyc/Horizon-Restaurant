...
CREATE TABLE `orders` (
  ...
  `orderStart` datetime DEFAULT NULL,
  `orderEstEnd` datetime DEFAULT NULL,
  `orderStatus` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`orderId`),
  KEY `fk_Orders_Restaurants1_idx` (`restaurantId`),
  CONSTRAINT `fk_Orders_Restaurants1` FOREIGN KEY (`restaurantId`) REFERENCES `restaurants` (`restaurantId`)
