...
class SideMenu(tk.Frame):
    def __init__(self, container):
        ...
        self.account_m = tk.Button(self, text="Account Management ", width=35, height=2, pady=5, padx=0,
                                   command=lambda: app.show_frame(AccountManagement))
        self.reports = tk.Button(self, text="reports", width=35, height=2, pady=5, padx=0,
                                 command=lambda: app.show_frame(Report))

        self.button_i = tk.Button(self, text="Inventory", width=35, height=2, pady=5, padx=0,
                                  command=lambda: app.show_frame(InventoryViewer))
        self.button_m = tk.Button(self, text="Menu", width=35, height=2, pady=5, padx=0,
                                  command=lambda: app.show_frame(MenuManagement))
        self.button_d = tk.Button(self, text="Discounts", width=35, height=2, pady=5, padx=0)
        ...
        self.table_management = tk.Button(self, text="Table Manager", width=35, height=2, pady=5, padx=0,
                                          command=lambda: app.show_frame(TableViewer))
        ...
        self.anchor = LEFT
        self.account_m.configure(bg='#0A0A0A', fg='white')  # Setting button color
        self.reports.configure(bg='#0A0A0A', fg='white')
        self.button_i.configure(bg='#0A0A0A', fg='white')
        self.button_m.configure(bg='#0A0A0A', fg='white')
        self.button_d.configure(bg='#0A0A0A', fg='white')
        self.order_management.configure(bg='#0A0A0A', fg='white')
        self.reservation_management.configure(bg='#0A0A0A', fg='white')
        self.table_management.configure(bg='#0A0A0A', fg='white')
        self.pay.configure(bg='#0A0A0A', fg='white')

        # Setting button color
        self.account_m.grid(row=0, sticky="w", ipady=(5))  # Setting button color
        self.reports.grid(row=1, sticky="w", ipady=5)
        self.button_i.grid(row=2, sticky="w", ipady=5)
        self.button_m.grid(row=3, sticky="w", ipady=5)
        self.button_d.grid(row=4, sticky="w", ipady=5)
        self.reports.grid(row=5, sticky="w", ipady=5)
        self.order_management.grid(row=6, sticky="w", ipady=5)
        self.reservation_management.grid(row=7, sticky="w", ipady=5)
        self.table_management.grid(row=8, sticky="w", ipady=5)
...
class Report(tk.Frame):
    def __init__(self, container):
        ...
        self.sales = tk.Button(self, text="Sales", width=35,command=lambda: generate_orders())
        self.serving_time = tk.Button(self, text="Serving time", width=35)
        self.bookings = tk.Button(self, text="Bookings", width=35,command=lambda: generate_sales())
